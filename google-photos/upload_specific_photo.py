...
def parse_args(arg_input=None):
    ...
    parser.add_argument('photos', metavar='photos',type=str, nargs='*',
                    help='filenames of a photo to upload')
...
def upload_photos_to_google_photos(session, album_name, photos):
        ...
        if (upload_token.status_code == 200) and (upload_token.content):
            ...
            if "newMediaItemResults" in resp:
                ...
                if status.get("code") and (status.get("code") > 0):
                    ...
                    logging.info("Added \'{}\' to library and album \'{}\' ".format(os.path.basename(photo), album_name))
            else:
...
if __name__ == "__main__":
    ...
    upload_photos_to_google_photos(session, args.album_name, args.photos)